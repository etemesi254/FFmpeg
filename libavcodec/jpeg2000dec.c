...
static inline void select_header(Jpeg2000DecoderContext *s,
                                 Jpeg2000DecTile *tile,
                                 int *tp_index)
{
...
static inline void select_stream(Jpeg2000DecoderContext *s,
                                 Jpeg2000DecTile *tile,
...
static int jpeg2000_decode_packet(Jpeg2000DecoderContext *s,
                                  Jpeg2000DecTile *tile, int *tp_index,
...
static inline void mct_decode(const Jpeg2000DecoderContext *s,
                              Jpeg2000DecTile *tile)
{
    int i, csize = 1;
    void *src[3];
                                   ...
                                   Jpeg2000DecTile *tile)
{
    ...
    int compno, reslevelno, bandno,subbandno;
